...
test_path       = './yolodata/aeroplane_Left_out_part02/test/indextest.txt'
num_classes     = 1
...
opt.batch_size = len(os.listdir('./yolodata/aeroplane_Left_out_part02/test/img/'))
...
for batch_i, (_, imgs, targets) in enumerate(dataloader):
    ...
    with torch.no_grad():
        output = model(imgs)
        data = output
        output = non_max_suppression(output, 1, conf_thres=0.5, nms_thres=0)
